-- C7.8F readonly post-revoke verify.
-- Expected: Phong Trong admin membership is revoked, Auth user still exists,
-- DreamHome admin remains active. No mutations in this file.
