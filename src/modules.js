export const modules = [
  ...
  },
  {
    id: 'nhom-tai-chinh',
    name: 'Sổ quỹ Thu chi',
    shortDescription: 'Quản lý giao dịch thu chi, số dư và đối soát quỹ trong một quy trình.',
    status: 'active',
    plannedFeatures: [
      'Ghi nhận và lọc giao dịch Thu/Chi',
      'Theo dõi số dư quỹ',
      'Đối soát và chốt sổ theo ngày',
      'Quản lý hạng mục giao dịch',
    ],
    plannedData: [
      'Giao dịch Thu/Chi',
      'Hạng mục',
      'Số dư và đối soát quỹ',
      'Nội dung chi tiết',
    ],
  },
  {
