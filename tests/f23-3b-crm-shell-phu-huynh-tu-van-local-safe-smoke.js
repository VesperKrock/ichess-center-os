...
assert(!mainSource.includes('forceContactValues'), 'Step 4 must derive shared facts from canonical contact values without a shadow-value preference mode.')
assert(mainSource.includes('enrollmentDraft: createEnrollmentDraftFromContact({'), 'Step 4 must rebuild its view from current canonical contact values.')
