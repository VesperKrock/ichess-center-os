...
assert(storageSource.includes("const SCHEDULE_KEY = createCenterScopedStorageKey('schedule')"))
assert(storageSource.includes("const CLASS_SESSIONS_KEY = createCenterScopedStorageKey('classSessions')"))
