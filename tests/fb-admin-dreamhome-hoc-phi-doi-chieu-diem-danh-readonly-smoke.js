...
assert(tuitionSource.includes('getLegacyTuitionRemainingSessions(tuition)'), 'Official remaining sessions should use validated stored session truth')
assert(tuitionSource.includes('return totalSessions - usedSessions'), 'Official legacy remaining sessions should still use stored usedSessions')
